...
- [ ] **DISP-01**: Performer can see the active `Instrument Selector` instrument in giant high-contrast text on the laptop
- [ ] **DISP-02**: Performer can switch the laptop view into a dedicated full-screen stage mode
